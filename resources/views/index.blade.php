...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('assets/images/logo-mini.jpg')}}">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-128682056-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-128682056-1');
    </script>
