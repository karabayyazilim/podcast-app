function skinChanger() {
    $(".right-sidebar .choose-skin li").on("click", function () {
        ...
        $(".right-sidebar .choose-skin li").removeClass("active"), a.removeClass(localStorage.getItem('mode_admin_skin')), b.addClass("active"), a.addClass("theme-" + b.data("theme"))
        localStorage.setItem('mode_admin_skin',"theme-" + b.data("theme"));
        a.addClass(localStorage.getItem('mode_admin_skin'));
...
$("body").addClass(localStorage.getItem('mode_admin_skin'));
...
function CustomJs() {
    $(".light_dark input").on("change", function () {
        ...
        "dark" == $(this).val() ? localStorage.setItem('mode_admin_theme', 'theme-dark') : localStorage.setItem('mode_admin_theme', 'theme-light')
...
$("body").addClass(localStorage.getItem('mode_admin_theme'));
localStorage.getItem('mode_admin_theme') == 'theme-dark' ? $('#darktheme').attr('checked',true) : $('#lighttheme').attr('checked',true);
